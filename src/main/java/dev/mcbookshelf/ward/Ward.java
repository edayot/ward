...
public class Ward implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, context, _) -> {
            // Standard registration into the server dispatcher
            ...
            // Create a isolated dispatcher dedicated to exporting mod-only commands
            CommandDispatcher<CommandSourceStack> modDispatcher = new CommandDispatcher<>();
            FailCommand.register(modDispatcher, context);
            SucceedCommand.register(modDispatcher, context);
            AssertCommand.register(modDispatcher, context);
            AwaitCommand.register(modDispatcher, context);
            DummyCommand.register(modDispatcher, context);
